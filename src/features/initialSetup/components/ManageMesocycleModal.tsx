    ...
    setChosenExercises(prevChosen => {
      if (isSelected) {
        ...
        const newChosenExercise: ChosenExerciseGoalData = {
          ...
          sets: '',
          reps: typeof exercise.default_reps === 'number' ? exercise.default_reps : "",
          weight: typeof exercise.default_weight === 'number' ? exercise.default_weight : "",
          duration_seconds: typeof exercise.default_duration_seconds === 'number' ? exercise.default_duration_seconds : "",
  ...
  const handleSubmitAllGoalsWrapper = useCallback(async () => {
    ...
    for (const chosenEx of chosenExercises) {
      ...
      const goalDataForHook: GoalInsert = {
        ...
        reps: chosenEx.reps === "" ? null : (chosenEx.reps == null ? null : Number(chosenEx.reps)),
        weight: chosenEx.weight === "" ? null : (chosenEx.weight == null ? null : Number(chosenEx.weight)),
        duration_seconds: chosenEx.duration_seconds === "" ? null : (chosenEx.duration_seconds == null ? null : Number(chosenEx.duration_seconds)),
